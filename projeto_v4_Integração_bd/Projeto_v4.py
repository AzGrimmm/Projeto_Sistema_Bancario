    ...
    while True:
        ...
        if opt == "d":
            try:
                ...
                cls.Deposito(valor).registrar(conta)
            except (ValueError):
            ...
            try:
                valor = float(input("Valor: R$"))
                cls.Saque(valor).registrar(conta)
            except (ValueError):
                print("Operação falhou! valor inválido!")
        elif opt == "e":
            try:
        ...
        while True:
            ...
            while True:
                ...
                if validacao:
                    ...
                    continue
            break
        obj_cliente = cls.PessoaFisica(cliente["nome"], cliente["cpf"], cliente["nascimento"], cliente["endereco"])
                ...
                if not cliente:
                    ...
                    while True:
                        ...
                        match opt:
                            ...
                            case "c":
                                try:
                                    conta = cls.ContaCorrente.nova_conta(cliente, len(contas_corrente) + 1)
                                except ():
